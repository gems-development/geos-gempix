...
public class MultiPolygonShortestLineSearcher : IModelDistanceCalculator
{
	...
	internal static double GetDistance(MultiPolygon multiPolygon1, MultiPolygon multiPolygon2) =>
		GetDistance(
			multiPolygon1,
			multiPolygon2,
			(polygon, primitive) => PolygonShortestLineSearcher.GetDistance(polygon, (MultiPolygon)primitive));

	internal static double GetDistance(MultiPolygon multiPolygon, MultiLine multiLine) =>
		GetDistance(
			multiPolygon,
			multiLine,
			(polygon, primitive) => PolygonShortestLineSearcher.GetDistance(polygon, (MultiLine)primitive));

	internal static double GetDistance(MultiPolygon multiPolygon, MultiPoint multiPoint) =>
		GetDistance(
			multiPolygon,
			multiPoint,
			(polygon, primitive) => PolygonShortestLineSearcher.GetDistance(polygon, (MultiPoint)primitive));

	internal static double GetDistance(MultiPolygon multiPolygon, Polygon polygon1) =>
		GetDistance(
			multiPolygon,
			polygon1,
			(polygon, primitive) => PolygonShortestLineSearcher.GetDistance(polygon, (Polygon)primitive));

	internal static double GetDistance(MultiPolygon multiPolygon, Line line) =>
		GetDistance(
			multiPolygon,
			line,
			(polygon, primitive) => PolygonShortestLineSearcher.GetDistance(polygon, (Line)primitive));
	...
	internal static double GetDistance(MultiPolygon multiPolygon, Point point) =>
		GetDistance(
			multiPolygon,
			point,
			(polygon, primitive) => PolygonShortestLineSearcher.GetDistance(polygon, (Point)primitive));
