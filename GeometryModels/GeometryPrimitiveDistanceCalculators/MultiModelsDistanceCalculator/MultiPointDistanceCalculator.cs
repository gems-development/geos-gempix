...
public class MultiPointDistanceCalculator : IModelDistanceCalculator
{
    ...
    public static double GetDistance(MultiPoint multiPoint, MultiPolygon multiPolygon)
    {
        return MultiPolygonDistanceCalculator.GetDistance(multiPolygon, multiPoint);
    }

    public static double GetDistance(MultiPoint multiPoint, MultiLine multiLine)
    {
        return MultiLineDistanceCalculator.GetDistance(multiLine, multiPoint);
    }

    public static double GetDistance(MultiPoint multiPoint1, MultiPoint multiPoint2) =>
         GetDistance(
             multiPoint1,
             multiPoint2,
             (point, primitive) => PointDistanceCalculator.GetDistance(point, primitive as MultiPoint));

    public static double GetDistance(MultiPoint multiPoint, Polygon polygon) =>
         GetDistance(
             multiPoint,
             polygon,
             (point, primitive) => PointDistanceCalculator.GetDistance(point, primitive as Polygon));

    public static double GetDistance(MultiPoint multiPoint, Line line) =>
         GetDistance(
             multiPoint,
             line,
             (point, primitive) => PointDistanceCalculator.GetDistance(point, primitive as Line));

    public static double GetDistance(MultiPoint multiPoint, Point point1) =>
         GetDistance(
             multiPoint,
             point1,
