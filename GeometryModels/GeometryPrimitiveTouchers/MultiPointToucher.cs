...
{
	public class MultiPointToucher : IModelsIntersector
	{
		...
		public static bool IsTouching(MultiPoint multiPoint, Point point1)
		{
		...
		public static bool IsTouching(MultiPoint multiPoint, Line line)
		{
			foreach (Point point in multiPoint.GetPoints())
			{
		...
		public static bool IsTouching(MultiPoint multiPoint, Polygon polygon)
		{
			foreach (Point point in multiPoint.GetPoints())
			{
		...
		public static bool IsTouching(MultiPoint multiPoint1, MultiPoint multiPoint2)
		{
