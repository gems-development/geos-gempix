...
namespace GeometryModels.GeometryPrimitiveTouchers
{
    public class MultiPolygonToucher : IModelsIntersector
    {
        ...
        public static bool IsTouching(MultiPolygon multiPolygon, Point point)
        {
        ...
        public static bool IsTouching(MultiPolygon multiPolygon, Line line)
        {
            foreach (Polygon polygon in multiPolygon.GetPolygons())
            {
        ...
        public static bool IsTouching(MultiPolygon multiPolygon, Polygon polygon1)
        {
            foreach (Polygon polygon in multiPolygon.GetPolygons())
            {
        ...
        public static bool IsTouching(MultiPolygon multiPolygon, MultiPoint multiPoint)
        {
            foreach (Polygon polygon in multiPolygon.GetPolygons())
            {
        ...
        public static bool IsTouching(MultiPolygon multiPolygon, MultiLine multiLine)
        {
            foreach (Polygon polygon in multiPolygon.GetPolygons())
            {
        ...
        public static bool IsTouching(MultiPolygon multiPolygon1, MultiPolygon multiPolygon2)
        {
