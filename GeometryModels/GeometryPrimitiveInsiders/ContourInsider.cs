...
namespace GeometryModels.GeometryPrimitiveInsiders
{
    public class ContourInsider
    {
        ...
        public static bool IsInside(Contour contour, Point point)
        {
        ...
        public static bool IsInside(Contour contour, Line line1)
        {
        ...
        public static bool IsInside(Contour contour, Polygon polygon)
        {
