...
namespace GeometryModels.GeometryPrimitiveIntersectors
{
    public class ContourIntersector : IModelsIntersector
    {
        ...
        public static bool Intersects(Contour contour, Point point)
        {
        ...
        public static bool Intersects(Contour contour, Line line1)
        {
            foreach (Line line in contour.GetLines())
            {
        ...
        public static bool Intersects(Contour contour1, Contour contour2)
        {
        ...
        public static bool Intersects(Contour contour1, Polygon polygon2)
        {
            foreach (Line line in contour1.GetLines())
            {
