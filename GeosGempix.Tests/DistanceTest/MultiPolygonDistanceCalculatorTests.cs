...
public class MultiPolygonDistanceCalculatorTests
{
    ...
    public void GetDistanceBetweenMultiPolygonAndMultiPolygon_Success(double res, double[] a, double[] b, double[] c)
    {
        ...
        var multiPolygon1 = TestHelper.CreateMultiPolygon(polygon1, polygon2, polygon3);
        ...
        //полигон 2
        var contour5 = TestHelper.CreateContour(
            new Point(2, 12),
            new Point(2, 16),
            new Point(6, 16),
            new Point(6, 12),
        ...
        var contours5 = new List<Contour>{ contour5 };
            
        var polygon5 = TestHelper.CreatePolygon(
            contours5,
            new Point(0, 10),
            new Point(0, 18),
            new Point(8, 18),
        ...
        //полигон 3
        var contour6 = TestHelper.CreateContour(
            new Point(12, 12),
            new Point(12, 16),
            new Point(16, 16),
            new Point(16, 12),
        ...
        var contours6 = new List<Contour>{ contour6 };
            
        var polygon6 = TestHelper.CreatePolygon(
            contours6,
            new Point(10, 10),
            new Point(10, 18),
            new Point(18, 18),
        ...
        var multiPolygon2 = TestHelper.CreateMultiPolygon(polygon4, polygon5, polygon6);
